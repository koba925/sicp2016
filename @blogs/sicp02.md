...
そういえばこういう記事がありました
どうしてMITではSICPを教えるのをやめてしまったのか、Gerry Sussmanに聞いたもの
...
（でも関数じゃなくてプリミティブとして実装されてたらしいですが）
...
3162277.6601683795と3162277.656326278を足して2で割っても
...
ソースコード上の、ではなくて実行時の呼び出しで上位にある関数内の変数を
下位の関数から参照できるようになっているものが動的スコープ
